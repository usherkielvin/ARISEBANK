...
public class PayInternet extends JPanel {
    ...
    public PayInternet(JFrame frame) {
        this.frame = frame;
        setLayout(null);
        ARISE.jtheme();
        ...
        add(backgroundLabel);
         ...
         JLabel selectService = new JLabel("INTERNET BILL PAYMENT");
...
//PIN MESSAGE
    ...
    private void validatePin() {
        ...
        if (!pinInput.isEmpty() && Integer.parseInt(pinInput) == ARISE.USER_PIN) {
            ...
            JOptionPane.showMessageDialog(this, "Internet bill successfully paid! \nNew  balance: " + ARISE.Currentbalance, 
