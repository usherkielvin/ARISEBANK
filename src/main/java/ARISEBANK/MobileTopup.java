...
public class MobileTopup extends JPanel {
    private JFrame frame;
    private JTextField amountField, AccountField;
    private JLabel backgroundLabel, selectService,amount,number;
    ...
    public MobileTopup(JFrame frame) {
        this.frame = frame;
        setLayout(null);
        ARISE.jtheme();
...
//TEXTBOX
    ...
    amountField.setBounds(35, 255, 250, 30);
...
//ACCOUNT FIELD
    ...
    AccountField.setBounds(35, 140, 250, 30);
    ...
    AccountField.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        public void keyTyped(java.awt.event.KeyEvent e) {
            ...
            if (!Character.isDigit(c) || currentText.length() >= 11) {
                e.consume();
            }
        }
    });
    AccountField.addActionListener(_ -> amountField.requestFocusInWindow());
...
//PIN MESSAGE
    ...
    private void showConfirmation() {
        ...
        try {
            ...
            loadAmount = Float.parseFloat(enteredAmount);
            if (ARISE.Currentbalance < loadAmount) {
                amountField.setText("");
                amountField.requestFocusInWindow();
                amountField.grabFocus();
            ...
            int response = JOptionPane.showConfirmDialog(this, 
                    "Are you sure you want to pay " + loadAmount + "?", 
                    "Bill Confirmation", 
    ...
    private void validatePin() {
        ...
        if (!pinInput.isEmpty() && Integer.parseInt(pinInput) == ARISE.USER_PIN) {
            loadAmount += Float.parseFloat(amountField.getText()) +15.00;
            ARISE.Currentbalance -= loadAmount;
            JOptionPane.showMessageDialog(this, "Bill successfully paid. \nNew  balance: " + ARISE.Currentbalance, 
