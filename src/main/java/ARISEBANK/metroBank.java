...
public class metroBank extends JPanel {
...
//WELCOME MESSAGE
    selectService = new JLabel("TRANSFER TO METROBANK ACCOUNT");
    selectService.setFont(new Font("Arial", Font.BOLD, 14));
    selectService.setForeground(Color.WHITE);
    selectService.setBounds(40, 90, 300, 30);
...
//PIN MESSAGE
    ...
    private void askForAReceipt() {
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            new Receipt("TRANSFER", amountPay,ARISE.Currentbalance).setVisible(true);
            timer();
