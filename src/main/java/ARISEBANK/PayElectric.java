...
public class PayElectric extends JPanel {
    ...
    public PayElectric(JFrame frame) {
        this.frame = frame;
        setLayout(null);
        ARISE.jtheme();

        backgroundLabel = new JLabel(new ImageIcon("ARISEBANK/Photos/q.png"));
        backgroundLabel.setBounds(0, 0, 600, 400);
        add(backgroundLabel);

         JLabel selectService = new JLabel("ELECTRIC BILL PAYMENT");
...
//TEXTBOX
 JLabel amount = new JLabel("Amount (service fee of PHP 10.00)");
    ...
    backgroundLabel.add(amount);
        ...
        ImageIcon banklogo = new ImageIcon("ARISEBANK/zlogo.png");
...
//PIN MESSAGE
    ...
    private void showConfirmation() {
        ...
        try {
            ...
            int response = JOptionPane.showConfirmDialog(this, 
                    "Are you sure you want to pay " + amountPay + "?", 
    ...
    private void validatePin() {
        ...
        if (!pinInput.isEmpty() && Integer.parseInt(pinInput) == ARISE.USER_PIN) {
            ...
            JOptionPane.showMessageDialog(this, "Electric bill successfully paid! \nNew  balance: " + ARISE.Currentbalance, 
    ...
    private void askForAReceipt() {
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            History.addTransaction("PAYBILLS", amountPay, ARISE.Currentbalance, atmId, transactionNumber);

            new Receipt("PAYBILLS", amountPay,ARISE.Currentbalance).setVisible(true);
            timer();
